...
# Require a valid logged in rails user!
$cookie = $_COOKIE['_mccs_session'. (strpos(__DIR__, '/mccsdev/') ? 'dev' : '')];
$json = `../../../decode_session_cookie.rb '$cookie'`;
...
$opts = array(
	...
	'roots' => array(
		array(
			...
			'path'          => '../../../../hrapply/public/uploads/',                 // path to files (REQUIRED)
			'URL'           => '/hrapply/uploads/', // URL to files (REQUIRED)
